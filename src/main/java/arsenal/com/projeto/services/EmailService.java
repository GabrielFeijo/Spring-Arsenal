...
public class EmailService {
    ...
    public void enviarEmailTemplate(String destinatario, String titulo, Map<String, Object> propriedades) {
	    ...
	    public void enviarEmailCadastro(String destinatario, String titulo, Map<String, Object> propriedades) {
	        MimeMessage mimeMessage =javaMailSender.createMimeMessage();
	           try {
	               ...
	               mimeMessageHelper.setText(getConteudoCadastro(propriedades), true);
       ...
       public String getConteudoCadastro(Map < String, Object >model)     { 
           StringBuffer content = new StringBuffer();
    
           try {
               content.append(FreeMarkerTemplateUtils.processTemplateIntoString(fmConfiguration.getTemplate("email-cadastro.flth"), model));
           } catch (Exception e) {
               e.printStackTrace();
           }
           return content.toString();
